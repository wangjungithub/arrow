...
//function createWebDriver (sid) {
SeleniumDriver.prototype.createWebDriver= function (sid) {
    var driver = new this.wd.Builder().
        usingServer(this.wdHubHost).
        usingSession(sid).
        withCapabilities(this.capabilities).build();
...
SeleniumDriver.prototype.createAdditionalWebDriver= function (name) {
    var driver;
    ...
    if (this.extra_webdrivers.hasOwnProperty(name)) {
        ...
        driver = this.createWebDriver(null);
