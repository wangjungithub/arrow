...
Here is the sample of using it on `test case <../../tests/functional/data/arrow_test/interaction/test-multisessions.js>`_.

Here is the sample of using it on `custom controller <../../tests/functional/data/arrow_test/interaction/controller-multisessions.js>`_.
